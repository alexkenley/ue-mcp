...
export const animationTool: ToolDef = categoryTool(
  ...
  undefined,
  {
    ...
    controlRigPath: z.string().optional().describe("begin_control_rig_edit: ControlRigBlueprint asset path; required when rigMode='asset'."),
    rigMode: z.enum(["fk", "asset"]).optional().describe("begin_control_rig_edit: 'fk' for UFKControlRig or 'asset' for controlRigPath."),
