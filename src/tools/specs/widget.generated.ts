...
export const schema: Record<string, z.ZodType> = {
  ...
  className: z.string().optional().describe("Widget class name that locates the live host widget"),
  ...
  direction: z.string().optional().describe("Up, Down, Left, Right, Next or Previous; omit to clear all six"),
  ...
  functionName: z.string().optional().describe("Widget Blueprint function the event key calls"),
  ...
  value: z.unknown().optional().describe("The keyed number (add_widget_animation_key). New value as UE export text, e.g. (Left=8,Top=8,Right=8,Bottom=8) (set_widget_property). JSON object mirroring the style struct, or a scalar (set_widget_style)"),
  ...
  widgetName: z.string().optional().describe("Name of a widget inside the tree (#798) (add_widget, add_widget_animation_key, add_widget_animation_track, clear_widget_binding, clear_widget_navigation, get_widget_details, get_widget_properties, move_widget, remove_widget, remove_widget_animation_key, remove_widget_animation_track, reorder_child, set_root_widget, set_widget_property, set_widget_style). Alias for sourceWidgetName (extract_widget_subtree). Exact live instance name. Provide this or className (get_runtime_delegates). Exact live instance name. Provide this or classFilter (inspect_runtime_instances). Named child of a live PIE widget, or the live UserWidget's own name (set_runtime_focus)"),
