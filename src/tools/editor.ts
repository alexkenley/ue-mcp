...
export const editorTool: ToolDef = categoryTool(
  ...
  "Editor commands, Python execution, PIE, undo/redo, hot reload, viewport, performance, sequencer, build pipeline, logs, editor control.",
  {
    ...
    list_crashes: bp("List crash reports. Params: none", "list_crashes"),
    ...
    get_dialog_policy: bp("Get current dialog policies. Params: none", "get_dialog_policy"),
    list_dialogs: bp("List active modal dialogs, with title, message text and button labels. Runs even while a dialog is blocking the editor, when every other handler times out. Params: none", "list_dialogs"),
