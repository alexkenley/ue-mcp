...
export const reflectionTool: ToolDef = categoryTool(
  ...
  undefined,
  {
    ...
    // Shared with set_enum_entries, whose spec declares an array of any element.
    entries: z.array(z.unknown()).optional().describe("Enum entries: strings, or {name, displayName?} objects (create_enum, set_enum_entries)"),
