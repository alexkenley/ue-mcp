...
bool FMCPHandlerRegistry::ReportsUnreadParams(const FString& Category)
{
	...
	static const TCHAR* const Reporting[] = { TEXT("animation"), TEXT("asset"), TEXT("blueprint"), TEXT("editor"), TEXT("gameplay"), TEXT("gas"), TEXT("level"), TEXT("material"), TEXT("niagara"), TEXT("pcg"), TEXT("sequencer"), TEXT("skeletalmesh"), TEXT("spline"), TEXT("widget") };
