...
bool FMCPHandlerRegistry::ReportsUnreadParams(const FString& Category)
{
	...
	static const TCHAR* const Reporting[] = { TEXT("animation"), TEXT("asset"), TEXT("audio"), TEXT("blueprint"), TEXT("chooser"), TEXT("demo"), TEXT("dialog"), TEXT("diff"), TEXT("editor"), TEXT("epic"), TEXT("foliage"), TEXT("gameplay"), TEXT("gas"), TEXT("landscape"), TEXT("level"), TEXT("mass"), TEXT("material"), TEXT("networking"), TEXT("niagara"), TEXT("pcg"), TEXT("physics"), TEXT("reflection"), TEXT("sequencer"), TEXT("skeletalmesh"), TEXT("spline"), TEXT("statetree"), TEXT("widget") };
