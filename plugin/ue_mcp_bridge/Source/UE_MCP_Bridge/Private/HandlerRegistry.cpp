...
bool FMCPHandlerRegistry::ReportsUnreadParams(const FString& Category)
{
	...
	static const TCHAR* const Reporting[] = { TEXT("animation"), TEXT("asset"), TEXT("audio"), TEXT("blueprint"), TEXT("chooser"), TEXT("demo"), TEXT("editor"), TEXT("foliage"), TEXT("gameplay"), TEXT("gas"), TEXT("landscape"), TEXT("level"), TEXT("material"), TEXT("niagara"), TEXT("pcg"), TEXT("physics"), TEXT("sequencer"), TEXT("skeletalmesh"), TEXT("spline"), TEXT("widget") };
