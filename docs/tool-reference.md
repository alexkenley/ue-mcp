...
| `render_thumbnail` | Render an asset PNG with Unreal's native thumbnail renderer. Supports renderable assets including static meshes, skeletal meshes, materials, and textures without level staging. Params: `assetPath, outputPath, width?, height?` |
