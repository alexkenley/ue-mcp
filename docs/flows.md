...
A task is a named unit of work. UE-MCP ships with **<!-- count:actions -->1966+<!-- /count --> built-in tasks** across <!-- count:tools -->26<!-- /count --> categories - every action available through the MCP tools is also a flow task.
...
| Layer | File | Purpose |
|-------|------|---------|
| 1 (base) | Built-in defaults | All <!-- count:actions -->1966+<!-- /count --> tasks, no flows |
